...
def generate():
	...
	inadjacency = os.getcwd() + "/../data/historical_matches.dat"
	...
	x = [1.5, 1]
	#print(tl.eqs39(tl.get_optimal_temperature(rank,A), x, A))
	#print(tl.eqs39(tl.get_optimal_temperature(rank,A), X, A))
	#print("Opt:", tl.get_optimal_temperature(rank, A))
